...
public class DanhSachHocSinh extends javax.swing.JFrame {
    ...
    public DanhSachHocSinh(int idLopDanhSach) throws SQLException {
        initComponents();
        LopCtrl lopCtrl = new LopCtrl();
        jTextFieldTenLop.setText(lopCtrl.getTenLopById(idLopDanhSach));

        setLocationRelativeTo(null);
        List<HoSoHocSinh> hoSoHocSinhs = lopCtrl.getAllHocSinhByIdLop(idLopDanhSach);
    ...
    private void initComponents() {
        ...
        jTextFieldTenLop.setEnabled(false);
